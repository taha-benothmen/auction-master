...
CREATE TABLE `users` (
  ...
  `theme_name` varchar(128) NOT NULL DEFAULT 'Voitures',
...
INSERT INTO `users` (`username`, `password`, `name`, `theme_name`, `description`, `IsAdmin`, `IsRh`, `verified`) VALUES
...
ALTER TABLE `contains`
  ADD PRIMARY KEY (`res_name`,`theme_name`,`type`),
  ADD KEY `type` (`type`);
...
ALTER TABLE `residences`
  ADD PRIMARY KEY (`res_name`,`theme_name`),
...
ALTER TABLE `reviews`
  ADD PRIMARY KEY (`rid`),
  ADD KEY `username` (`username`),
  ADD KEY `res_name` (`res_name`,`theme_name`);
...
ALTER TABLE `sublets`
  ADD PRIMARY KEY (`lid`),
  ADD KEY `res_name` (`res_name`,`theme_name`,`type`);
...
--
ALTER TABLE `contains`
  ADD CONSTRAINT `contains_ibfk_1` FOREIGN KEY (`res_name`,`theme_name`) REFERENCES `residences` (`res_name`, `theme_name`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `residences`
  ...
  ADD CONSTRAINT `residences_ibfk_1` FOREIGN KEY (`theme_name`) REFERENCES `themes` (`theme_name`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `reviews`
  ...
  ADD CONSTRAINT `reviews_ibfk_2` FOREIGN KEY (`res_name`,`theme_name`) REFERENCES `residences` (`res_name`, `theme_name`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `sublets`
  ...
  ADD CONSTRAINT `sublets_ibfk_2` FOREIGN KEY (`res_name`,`theme_name`,`type`) REFERENCES `contains` (`res_name`, `theme_name`, `type`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`theme_name`) REFERENCES `themes` (`theme_name`) ON UPDATE CASCADE;
COMMIT;
